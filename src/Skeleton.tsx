...
const importantBones = [
  ...
  { name_jp: "右指１", name_en: "rightThumb1" },
  { name_jp: "右指２", name_en: "rightThumb2" },
  { name_jp: "右指１", name_en: "rightIndex1" },
  { name_jp: "右指２", name_en: "rightIndex2" },
  { name_jp: "右指３", name_en: "rightIndex3" },
  { name_jp: "右中指１", name_en: "rightMiddle1" },
  { name_jp: "右中指２", name_en: "rightMiddle2" },
  { name_jp: "右中指３", name_en: "rightMiddle3" },
  { name_jp: "右指１", name_en: "rightRing1" },
  { name_jp: "右指２", name_en: "rightRing2" },
  { name_jp: "右指３", name_en: "rightRing3" },
  { name_jp: "右小指１", name_en: "rightPinky1" },
  { name_jp: "右小指２", name_en: "rightPinky2" },
  { name_jp: "右小指３", name_en: "rightPinky3" },
  { name_jp: "左指１", name_en: "leftThumb1" },
  { name_jp: "左指２", name_en: "leftThumb2" },
  ...
  { name_jp: "左指１", name_en: "leftRing1" },
  { name_jp: "左指２", name_en: "leftRing2" },
  { name_jp: "左指３", name_en: "leftRing3" },
